...
private val BlueAccent = Color(0xFF93C5FD)

/**
 * Splash screen with animated spotlight overlay.
 * Shows the master art with crossing light beams, then navigates.
 */
@Composable
fun SplashScreen(
    onFinished: () -> Unit,
...
private fun SplashScreenContent(
    ...
    Box(
        ...
        SpotlightOverlay(
            ...
            core = BlueAccent.copy(alpha = 0.20f),
            mid = BlueLight.copy(alpha = 0.13f),
            wide = BluePrimary.copy(alpha = 0.07f),
            modifier = Modifier.fillMaxSize()
        )
    }
}
