...
```bash
# TCL TV (primary testing device)
adb -s 192.168.1.199:5555 install -r "/mnt/c/Users/jausc/StudioProjects/MyFlix/app-tv/build/outputs/apk/debug/app-tv-universal-debug.apk"
